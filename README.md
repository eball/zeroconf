...
[![GoDoc](https://godoc.org/github.com/eball/zeroconf?status.svg)](https://godoc.org/github.com/eball/zeroconf)
[![Go Report Card](https://goreportcard.com/badge/github.com/eball/zeroconf)](https://goreportcard.com/report/github.com/eball/zeroconf)
[![Tests](https://github.com/eball/zeroconf/actions/workflows/go-test.yml/badge.svg)](https://github.com/eball/zeroconf/actions/workflows/go-test.yml)

## Install
Nothing is as easy as that:
```bash
$ go get -u github.com/eball/zeroconf
```
...
See https://github.com/eball/zeroconf/blob/master/examples/resolv/client.go.
...
See https://github.com/eball/zeroconf/blob/master/examples/register/server.go.
